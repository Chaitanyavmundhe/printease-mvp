...
const getNextJob = asyncHandler(async (req, res) => {
...
const getPredownloadCandidates = asyncHandler(async (req, res) => {
...
const acceptJob = asyncHandler((req, res) => {
...
const markDownloading = asyncHandler((req, res) => {
  return updateJobFromAgent({
    req,
    res,
...
const markPrinting = asyncHandler((req, res) => {
  return updateJobFromAgent({
    req,
    res,
...
const markCompleted = asyncHandler((req, res) => {
  return updateJobFromAgent({
    req,
    res,
...
const markFailed = asyncHandler((req, res) => {
  return updateJobFromAgent({
    req,
    res,
...
const markCancelled = asyncHandler((req, res) => {
  return updateJobFromAgent({
    req,
    res,
