...
try {
  ...
  const bridge = {
    ...
    startApprovalPairing: (payload) => ipcRenderer.invoke("agent:start-approval-pairing", payload),
    ...
    confirmApprovalPairing: (pairingSessionId) => ipcRenderer.invoke("agent:confirm-approval-pairing", { pairingSessionId }),
